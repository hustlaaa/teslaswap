...
// Thanks to: https://github.com/emilianobonassi/usdc-to-any-synths
...
contract USDC2AnySynthsV1 {
    modifier ownerOnly {
        require(address(msg.sender) == address(owner), "you must be admin");
        _;
    }
    ...
    // Partner program
    bytes32 public trackingCode = 0x534e582e4c494e4b000000000000000000000000000000000000000000000000;

    // Custom referral initiative
    address public originator = 0x59846C1F45C67FA757438EC1B67bdd72BBe483b7;
    ...
    // Admin methods:
    function changeTracking(bytes32 newTracking) public ownerOnly {
        trackingCode = newTracking;
    }
    function changeOwner(address newOwner) public ownerOnly {
        owner = newOwner;
    }
    function changeOriginator(address newOriginator) public ownerOnly {
